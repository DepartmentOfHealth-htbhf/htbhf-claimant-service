...
import static uk.gov.dhsc.htbhf.claimant.regex.PostcodeRegex.UK_POST_CODE_REGEX_V3;
...
public class AddressDTO {
    ...
    @NotNull
    @Pattern(regexp = UK_POST_CODE_REGEX_V3, message = "invalid postcode format")
