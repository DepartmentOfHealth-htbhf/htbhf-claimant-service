...
public class ClaimDTO {
    ...
    @ApiModelProperty(notes = "The claim's id as stored in the database", example = "96c3f8c0-f6d9-4ad4-9ed9-72fcbd8d692d")
    @JsonProperty("id")
    private UUID id;

    @ApiModelProperty(notes = "The claim's current status", example = "ACTIVE, NEW, REJECTED, PENDING_EXPIRY, EXPIRED")
    ...
    @ApiModelProperty(notes = "The claim's eligibility status", example = "ELIGIBLE, INELIGIBLE, PENDING, NO_MATCH, ERROR, DUPLICATE")
    ...
    @ApiModelProperty(notes = "the current card status", example = "ACTIVE, PENDING_CANCELLATION, SCHEDULED_FOR_CANCELLATION, CANCELLED")
